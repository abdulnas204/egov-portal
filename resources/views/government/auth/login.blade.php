...
@section('content')
    <div class="card">
        ...
        <form action="{{ route('government.login') }}" method="post">
            {{ csrf_field() }}
            <div class="card-body">
                <div class="text-center pb-3">
                    <img src="http://lostisland.org/wp-content/uploads/2017/07/For-Favicon-4.png" width="150"><br>
                    <strong class="text-danger">EYES ONLY!</strong>
                </div>

                @include('errors.list')

                <div class="form-group{{ $errors->has('username') ? ' is-invalid' : '' }}">
                    <label for="username" class="sr-only">{{ trans('form.username2') }}</label>
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="username" name="username" value="{{ old('username') }}" placeholder="{{ trans('form.username2') }}...">
                    </div>
                </div>
